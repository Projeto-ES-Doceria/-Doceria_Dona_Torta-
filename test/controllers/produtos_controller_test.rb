...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { descricao: @produto.descricao, fabricacao: @produto.fabricacao, nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade, vencimento: @produto.vencimento } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { descricao: @produto.descricao, fabricacao: @produto.fabricacao, nome: @produto.nome, preco: @produto.preco, quantidade: @produto.quantidade, vencimento: @produto.vencimento } }
